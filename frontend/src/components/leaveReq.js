                ...
                <div className="container" >
                    ...
                    <form className="needs-validation" onSubmit={this.onsubmit}>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input className="form-control" name="lecId" value={this.state.lecId} onChange={this.handleInputChange} required />
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input className="form-control" name="name" value={this.state.name} onChange={this.handleInputChange} required />
                        </div>
                        <br></br>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="date" className="form-control" name="beginDate" value={this.state.beginDate} onChange={this.handleInputChange} required />
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea className="form-control" name="reason" cols="25" rows="3" value={this.state.reason} onChange={this.handleInputChange} required />
                        </div>
                        <br></br>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input className="form-control" name="Cnumber" value={this.state.Cnumber} onChange={this.handleInputChange} required />
                        </div>
                        <br></br>


                        <center><button type="submit" className="btn btn-primary">Send Request</button>
                        </center>
                        <br></br>
                    </form>
