...
<input className="form-control" name="registrationNo" aria-describedby="emailHelp" value={this.state.registrationNo} onChange={this.handleInputChange}required/>
</div>
<div className="mb-3">
...
<center><button type="submit" className="btn btn-dark"> &nbsp; SUBMIT &nbsp;</button></center>
</form>&nbsp;
   </div>
   </div>
   </div>
