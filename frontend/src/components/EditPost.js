...
onsubmit = (e) =>{
    ...
    render(){
       ...
       <h1><p class="fs-1"> Update Student details  </p></h1>
        &nbsp;&nbsp;
       <form className="needs-validation" noValidate>
       <div className="mb-3">
<label for="exampleInputEmail1" className="form-label"> <p class="fw-bold">Registraion No</p></label>
<input type="text" className="form-control" name="registrationNo" aria-describedby="emailHelp" value={this.state.registrationNo} onChange={this.handleInputChange}/>
</div>
<div className="mb-3">
...
<center><button type="submit" className="btn btn-secondary" onClick={this.onsubmit}> SAVE ALL DETAILS </button></center>
</form>
   </div>
   </div>
   )
